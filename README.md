...
#This project has been deprecated - please see Xero's official PHP SDK https://github.com/XeroAPI/xero-php-oauth2

This is an experimental PHP SDK generated from Xero API OpenAPI Spec for oAuth 2 (generated by Openapi Generator https://github.com/openapitools/openapi-generator)
...
```
{
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/SidneyAllen/xero-php.git"
    }
  ],
  "require": {
    "SidneyAllen/xero-php": "*@dev"
  }
}
```
...
```php
    require_once('/path/to/xero-php/vendor/autoload.php');
```
