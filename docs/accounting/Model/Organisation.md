...
**base_currency** | [**\SidneyAllen\XeroPHP\Models\Accounting\CurrencyCode**](CurrencyCode.md) |  | [optional] 
**country_code** | [**\SidneyAllen\XeroPHP\Models\Accounting\CountryCode**](CountryCode.md) |  | [optional] 
...
**timezone** | [**\SidneyAllen\XeroPHP\Models\Accounting\TimeZone**](TimeZone.md) |  | [optional] 
...
**addresses** | [**\SidneyAllen\XeroPHP\Models\Accounting\Address[]**](Address.md) | Address details for organisation – see Addresses | [optional] 
**phones** | [**\SidneyAllen\XeroPHP\Models\Accounting\Phone[]**](Phone.md) | Phones details for organisation – see Phones | [optional] 
**external_links** | [**\SidneyAllen\XeroPHP\Models\Accounting\ExternalLink[]**](ExternalLink.md) | Organisation profile links for popular services such as Facebook,Twitter, GooglePlus and LinkedIn. You can also add link to your website here. Shown if Organisation settings  is updated in Xero. See ExternalLinks below | [optional] 
