...
class IdentityApi
{
     ...
     * @return void
     */
    public function refreshToken($grant_type = null, $content_type = null, $grant_type = null, $refresh_token = null, $client_id = null, $client_secret = null)
    {
        $this->refreshTokenWithHttpInfo($grant_type, $content_type, $grant_type, $refresh_token, $client_id, $client_secret);
    }
     ...
     */
    public function refreshTokenWithHttpInfo($grant_type = null, $content_type = null, $grant_type = null, $refresh_token = null, $client_id = null, $client_secret = null)
    {
        $request = $this->refreshTokenRequest($grant_type, $content_type, $grant_type, $refresh_token, $client_id, $client_secret);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshTokenAsync($grant_type = null, $content_type = null, $grant_type = null, $refresh_token = null, $client_id = null, $client_secret = null)
    {
        return $this->refreshTokenAsyncWithHttpInfo($grant_type, $content_type, $grant_type, $refresh_token, $client_id, $client_secret)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshTokenAsyncWithHttpInfo($grant_type = null, $content_type = null, $grant_type = null, $refresh_token = null, $client_id = null, $client_secret = null)
    {
        $returnType = '';
        $request = $this->refreshTokenRequest($grant_type, $content_type, $grant_type, $refresh_token, $client_id, $client_secret);
