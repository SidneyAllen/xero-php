...
class ExpenseClaim implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \DateTime|null $payment_due_date The date when the expense claim is due to be paid YYYY-MM-DD
     *
     * @return $this
     */
     ...
     * Sets reporting_date
     *
     * @param \DateTime|null $reporting_date The date the expense claim will be reported in Xero YYYY-MM-DD
     *
     * @return $this
     */
