...
class AssetType implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['asset_type_id'] === null) {
            $invalidProperties[] = "'asset_type_id' can't be null";
        }
     ...
     * Sets asset_type_id
     *
     * @param string $asset_type_id Xero generated unique identifier for asset types
     *
     * @return $this
     */
