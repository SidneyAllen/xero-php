...
class LeaveType implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'normal_entitlement' => 'int',
        'leave_loading_rate' => 'int',
     ...
     *
     * @param int|null $normal_entitlement The number of units the employee is entitled to each year
     *
     * @return $this
     */
     ...
     *
     * @param int|null $leave_loading_rate Enter an amount here if your organisation pays an additional percentage on top of ordinary earnings when your employees take leave (typically 17.5%)
     *
     * @return $this
     */
